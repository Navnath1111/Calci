...
btn_add=Button(root,text="+",bg="grey",fg="orange",width=5,height=2,command=lambda:get_operator('+'))
...
btn_sub=Button(root,text="-",bg="grey",fg="orange",width=5,height=2,command=lambda:get_operator('-'))
...
btn_mul=Button(root,text="*",bg="grey",fg="orange",width=5,height=2,command=lambda:get_operator('*'))
btn_mul.grid(row=3,column=3)           
btn_mul.config(font=("verdana",14,'bold'))

btn_c=Button(root,text="C",bg="orange",fg="white",width=5,height=2,command=lambda:clear())
btn_c.grid(row=4,column=0)           
btn_c.config(font=("verdana",14,'bold'))
...
btn_div=Button(root,text="/",bg="grey",fg="orange",width=5,height=2,command=lambda:get_operator('/'))
